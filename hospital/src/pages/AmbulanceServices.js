      ...
      <Box sx={{ padding: "40px", backgroundColor: "#f8f9fa" }}>
        ...
        <Box sx={{ marginBottom: "50px" }}>
          ...
          <Grid container spacing={4}>
            {[
              { name: "Basic Life Support (BLS)", image: "/images/bls-ambulance.jpg", description: "For non-critical patients requiring basic medical care and transportation." },
              { name: "Advanced Life Support (ALS)", image: "/images/als-ambulance.jpg", description: "Equipped with advanced medical equipment for critical patients." },
              { name: "Neonatal Ambulance", image: "/images/neonatal-ambulance.jpg", description: "Specially designed for transporting infants with medical supervision." },
              { name: "Critical Care Ambulance", image: "/images/critical-care-ambulance.jpg", description: "For patients needing intensive monitoring and medical intervention during transportation." },
            ].map((ambulance, index) => (
